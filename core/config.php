...
ini_set ('include_path', 
			...
			PATH_SEPARATOR . CLEANGAB_FWK_ROOT . 
			PATH_SEPARATOR . CLEANGAB_FWK_CONTROL . 
			PATH_SEPARATOR . CLEANGAB_FWK_MODEL . 
			PATH_SEPARATOR . CLEANGAB_FWK_VIEW . 
			PATH_SEPARATOR . CLEANGAB_FWK_ORM . 
			PATH_SEPARATOR . CLEANGAB_FWK_SECURITY . 
